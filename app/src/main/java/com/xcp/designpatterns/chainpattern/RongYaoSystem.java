 ...
 *
 */
public class RongYaoSystem extends Handler<UserInfo>{
    private List<UserInfo> userInfos;

    public RongYaoSystem() {
        this.userInfos = new ArrayList<>();
        userInfos.add(new UserInfo("JACK","123456",12));
        userInfos.add(new UserInfo("LILEI","123456",18));
        userInfos.add(new UserInfo("TOM","123456",22));
    }
